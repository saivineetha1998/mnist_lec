...
for i in gma:
    ...
    f1scores.append(f1_score(y_test, predicted, average='weighted'))
    print(i, " -> ", accuracy_score(y_test, predicted), " ->", f1_score(y_test, predicted, average='weighted'))

plt.plot(gma, accuracies)
plt.xlabel('Gamma Values')
plt.ylabel('Accuracies')
plt.show()

plt.plot(gma, f1scores)
plt.xlabel('Gamma Values')
