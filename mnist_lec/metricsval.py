...
for i in gma:
    ...
    X_tr, X_test, y_tr,  y_test = train_test_split(
        data, digits.target, train_size=0.85, test_size=0.15, shuffle=False)
    X_train, X_val, y_train,  y_val = train_test_split(
        data, digits.target, train_size=0.7, test_size=0.15, shuffle=False)
    ...
    print("test", i, " -> ", accuracy_score(y_test, predicted), " ->", f1_score(y_test, predicted, average='weighted'))
